...
def generate_launch_description():
    ...
    # Main bridge — all topics including raw camera image
    gz_bridge_node = Node(
        ...
        arguments=[
            ...
            # /tf commented out: EKF publishes filtered tf instead
    ...
    # Compressed image bridge (optional, adds JPEG-compressed stream alongside raw)
    ...
    # Trajectory server for raw odometry (yellow path in RViz)
    trajectory_odom_node = Node(
        package='trajectory_server',
        executable='trajectory_server',
        name='trajectory_server_odom',
        parameters=[
    ...
    # Trajectory server for EKF-filtered odometry (green path in RViz)
    ...
    launchDescriptionObject.add_action(trajectory_odom_node)
