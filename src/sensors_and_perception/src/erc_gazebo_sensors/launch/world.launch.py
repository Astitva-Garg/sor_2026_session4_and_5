...
def generate_launch_description():
    ...
    # Gazebo models path: repo ships its own gazebo_models one level above the package
    gazebo_models_path = os.path.expanduser('~/sor_ws/src/sensors_and_perception/gazebo_models')
